    ...
    <div class="row h-100">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="h4 mb-0">Добавление видео</h2>
            ...
            <form action="create.php" method="post" class="needs-validation" novalidate>
                ...
                <div class="form-check mb-3">
                    <input class="form-check-input" type="checkbox" value="1" id="videoStatus" name="video_status" checked>
                    <label class="form-check-label" for="videoStatus">
                        Опубликовать видео
                    </label>
                </div>

                <button type="submit" class="btn btn-success" name="btn-create-video">Добавить видео</button>
            </form>
        </main>
    </div>
</div>
