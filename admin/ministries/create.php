...
require_once("../../app/controllers/ministries.php"); // контроллер, где есть $errors и $formData
?>
<!doctype html>
<html lang="ru">
<head>
    ...
    <div class="row h-100">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="h4 mb-0">Добавление служения</h2>
                <div>
            ...
            <form action="create.php" method="post" class="needs-validation" novalidate>
                ...
                <button type="submit" class="btn btn-success">Добавить служение</button>
            </form>
        </main>
    </div>
</div>
