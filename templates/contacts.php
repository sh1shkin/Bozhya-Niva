...
<body>
  ...
  <main class="container">
    ...
    <section class="section write-us">
      <h2>Напишите нам</h2>
      <p>Если у вас есть вопросы, молитвенные нужды или предложения — не стесняйтесь связаться с нами. Мы постараемся ответить как можно скорее.</p>
      <a href="mailto:info@bozhyaniva.ru" class="write-link">Отправить письмо</a>
    </section>
  </main>
